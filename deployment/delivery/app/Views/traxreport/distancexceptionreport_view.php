...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="search-panel">
                ...
                <h4>Search</h4>              
                <form action="<?= base_url('traxreport/distancexception')?>" method="post" autocomplete="off" name="frmsearch" id="frmsearch">
				<?= csrf_field() ?>
                    <div class="form-row">
                ...
                <div class="table-responsive">
					...
					<table class="table table-bordered" id="lists" width="100%" cellspacing="0">
						...
						<tbody class="reportlists-body">
							...
							//print_r($mdddevicename_arr);exit;
							...
							//if($irow->acting_trip != '' && $irow->status == 'Duty Not Completed'){
								...
								<td>'.$irow->stoppol.'</td>
								<td>'.round($irow->totaldistancecovere_taa/1000,2).' km</td>
								<td>'.$irow->walk_org_distance_out.' Km</td>
							...
							<tr>
								<td colspan="13">No Devices Assigned</td>
							</tr>
							<?php } ?>
						</tbody>
						<?php } ?>
    ...
    <script>
		...
		function pdfSubmit(){
			submitFRM(BASEURL + 'traxreport/distanceexceptionreportpdf');
		}
		
		function excelSubmit(){
			submitFRM(BASEURL + 'traxreport/distanceexceptionreportexcel');
		}		
