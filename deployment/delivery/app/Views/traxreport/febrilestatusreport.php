...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        ...
        <div class="search-panel">
            ...
            ?>           
                <?php echo form_open("traxreport/febrilestatusreport",array("autocomplete"=>"off","name"=>"frmsearch","onsubmit"=>"return submit_form();")) ?>
                    <div class="form-row">
    ...
    <div class="table-responsive">
		<table class="table table-bordered" id="reportlists" width="100%" cellspacing="0">
			...
			<tbody class="reportlists-body">
				<?php if(count($details) > 0){
					foreach($details as $details_each){
				?>
				<tr>
					<td><?php echo $details_each['device_name']; ?></td>
					<td><?php echo $details_each['serial_no']; ?></td>
					<td><?php echo $details_each['date_time']; ?></td>
					<td><?php echo round($details_each['temperature'],1); ?></td>
				</tr>
				<?php } ?>				
				<?php } else { ?>
...
<script>
    $(document).ready(function() {
		...
		$("#res").on('click', function() {
			window.location.href = BASEURL + 'traxreport/febrilestatusreport';
		});
