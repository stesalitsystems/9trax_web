...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="search-panel">
                ...
                <h4>Search</h4>              
                <form action="<?= base_url()?>report/geofencegroup" method="post" autocomplete="off" name="frmsearch" id="frmsearch">
					<?= csrf_field() ?>
					<div class="form-row">
                ...
                <div class="table-responsive">
					...
					<table class="table table-bordered" id="reportlists" width="100%" cellspacing="0">
						<!-- <thead>
							<tr>
							<th colspan="9"> Geofence Group Report From <?php echo date("d-m-Y H:i", strtotime($stdt));?> To <?php echo date("d-m-Y H:i", strtotime($endt));?></th>
							</tr>
						</thead> -->
						<thead>
							<tr>
    ...
    <script>
		...
		function pdfSubmit() {
			...
			document.frmsearch.action = BASEURL + 'report/geofencegroupPdf';
			document.frmsearch.submit();
			document.frmsearch.action = prevURL;
		}
